...
public class Enigme6Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.enigme6_view); //Lien avec le layout
        reponse = findViewById(R.id.reponseEnigme6_txt); //Lien avec le layout
        valider = findViewById(R.id.validerEnigme6_btn); //Lien avec le layout
        indice1 = findViewById(R.id.indice6_btn); //Lien avec le layout
        nbindice = findViewById(R.id.nbindice6_view); //Lien avec le layout
        ...
        Boolean cc2 = sharedPreferences.getBoolean("6", false);//Recuperation des preferences
        ...
        valider.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) { //Lorque l'utilisateur appuie sur le bouton valider
                vib.vibrate(10);
                Intent intent = new Intent(Enigme6Activity.this, CoordonneeActivity.class);
                Bundle bundle = new Bundle();
                bundle.putString("coordonnee8_txt", ev_reponse);
        ...
        indice1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) { //Lorque l'utilisateur appuie sur le bouton indice
                        ...
                        editor.putBoolean("6", NombreIndice);
                        editor.apply(); //Permet de sauvegarder dans les preferences l'utilisation d'un indice
                        trouve = true;
                        Intent intent = new Intent(Enigme6Activity.this, QuestionnaireActivity.class);
                        Bundle bundle = new Bundle();
                        bundle.putBoolean("indices6_txt", trouve);
                        intent.putExtras(bundle);
                        startActivity(intent);
