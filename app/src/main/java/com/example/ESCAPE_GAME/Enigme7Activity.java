...
public class Enigme7Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.enigme7_view); //Lien avec le layout
        reponse = findViewById(R.id.reponseEnigme7_txt); //Lien avec le layout
        valider = findViewById(R.id.validerEnigme7_btn); //Lien avec le layout
        indice1 = findViewById(R.id.indice7_btn); //Lien avec le layout
        nbindice = findViewById(R.id.nbindice7_view); //Lien avec le layout
        valider.setEnabled(false); //On bloque le bouton valider tant qu'une valeur n'a pas ete saisie
        indice1.setEnabled(true); //Possiblite d'appuyer sur le bouton indice
        ...
        Boolean cc2 = sharedPreferences.getBoolean("7", false);//Recuperation des preferences
        ...
        valider.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) { //Lorque l'utilisateur appuie sur le bouton valider
                vib.vibrate(10);
                Intent intent = new Intent(Enigme7Activity.this, CoordonneeActivity.class);
                Bundle bundle = new Bundle();
                bundle.putString("coordonnee10_txt", ev_reponse);
        ...
        indice1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) { //Lorque l'utilisateur appuie sur le bouton indice
                        ...
                        editor.putBoolean("7", NombreIndice);
                        editor.apply(); //Permet de sauvegarder dans les preferences l'utilisation d'un indice
                        trouve = true;
                        Intent intent = new Intent(Enigme7Activity.this, QuestionnaireActivity.class);
                        Bundle bundle = new Bundle();
                        bundle.putBoolean("indices7_txt", trouve);
                        intent.putExtras(bundle);
                        startActivity(intent);
