...
public class Enigme9Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.enigme9_view); //Lien avec le layout
        reponse = findViewById(R.id.reponseEnigme9_txt); //Lien avec le layout
        valider = findViewById(R.id.validerEnigme9_btn); //Lien avec le layout
        indice1 = findViewById(R.id.indice9_btn); //Lien avec le layout
        nbindice = findViewById(R.id.nbindice9_view); //Lien avec le layout
        ...
        Boolean cc2 = sharedPreferences.getBoolean("9", false);//Recuperation des preferences
        ...
        reponse.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                valider.setEnabled(true); //Déblocage du bouton valider
        ...
        valider.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) { //Lorsque l'utilisateur appuie sur le bouton valider
                vib.vibrate(10);
                Intent intent = new Intent(Enigme9Activity.this, CoordonneeActivity.class);
                Bundle bundle = new Bundle();
                bundle.putString("coordonnee12_txt", ev_reponse);
        ...
        indice1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) { //Lorsque l'utilisateur appuie sur le bouton indice
                        ...
                        editor.putBoolean("9", NombreIndice);
                        editor.apply(); //Permet de sauvegarder dans les preferences l'utilisation d'un indice
                        trouve = true;
                        Intent intent = new Intent(Enigme9Activity.this, QuestionnaireActivity.class);
                        Bundle bundle = new Bundle();
                        bundle.putBoolean("indices9_txt", trouve);
                        intent.putExtras(bundle);
                        startActivity(intent);
