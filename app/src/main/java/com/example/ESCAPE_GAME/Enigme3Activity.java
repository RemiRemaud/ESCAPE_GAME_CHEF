...
public class Enigme3Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.enigme3_view); //Lien avec le layout
        reponse = findViewById(R.id.reponseEnigme3_txt); //Lien avec le layout
        nbindice = findViewById(R.id.nbindice3_view); //Lien avec le layout
        valider = findViewById(R.id.validerEnigme3_btn); //Lien avec le layout
        indice1 = findViewById(R.id.indice3_btn); //Lien avec le layout
        valider.setEnabled(false); //Blocage du bouton valider tant qu'une valeur n'a pas été saisie
        ...
        Boolean cc2 = sharedPreferences.getBoolean("3", false);//Récupération des preferences
        ...
        reponse.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                valider.setEnabled(true); //On débloque le bouton valider
        ...
        valider.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) { //Lorsque l'utilisateur appuie sur le bouton valider
                vib.vibrate(10);
                Intent intent = new Intent(Enigme3Activity.this, CoordonneeActivity.class);
                Bundle bundle = new Bundle();
                bundle.putString("coordonnee4_txt", ev_reponse);
        ...
        indice1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) { //Lorque l'utilisateur appuie sur le bouton indice
                        ...
                        editor.putBoolean("3", NombreIndice);
                        editor.apply(); //Permet de sauvegarder dans les preferences l'utilisation d'un indice
                        trouve = true;
                        Intent intent = new Intent(Enigme3Activity.this, QuestionnaireActivity.class);
                        Bundle bundle = new Bundle();
                        bundle.putBoolean("indices3_txt", trouve);
                        intent.putExtras(bundle);
                        startActivity(intent);
