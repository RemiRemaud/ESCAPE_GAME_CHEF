...
public class Indice4Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.question4_view);
        valider = findViewById(R.id.indice4_btn);
        commentaire = findViewById(R.id.IndiceReponse4_view);
        Box1 = findViewById(R.id.checkbox4_1);
        Box2 = findViewById(R.id.checkbox4_2);
        Box3 = findViewById(R.id.checkbox4_3);
        Box4 = findViewById(R.id.checkbox4_4);
        indice = findViewById(R.id.image4View);
        ...
        retour.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                vib.vibrate(10);
                Intent intent = new Intent(Indice4Activity.this, Enigme4Activity.class);
