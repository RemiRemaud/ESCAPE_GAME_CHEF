...
public class Indice3Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.question3_view);
        reponse = findViewById(R.id.reponse3_txt);
        valider = findViewById(R.id.indice3_btn);
        commentaire = findViewById(R.id.IndiceReponse3_view);
        indice = findViewById(R.id.image3View);
        indice_comment = findViewById(R.id.Indice3_view);
        ...
        retour.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                vib.vibrate(10);
                Intent intent = new Intent(Indice3Activity.this, Enigme3Activity.class);
