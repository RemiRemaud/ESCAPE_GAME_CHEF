...
public class Enigme8Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.enigme8_view); //Lien avec le layout
        reponse = findViewById(R.id.reponseEnigme8_txt); //Lien avec le layout
        valider = findViewById(R.id.validerEnigme8_btn); //Lien avec le layout
        indice1 = findViewById(R.id.indice8_btn); //Lien avec le layout
        nbindice = findViewById(R.id.nbindice8_view); //Lien avec le layout
        ...
        Boolean cc2 = sharedPreferences.getBoolean("8", false);//Recuperation des preferences
        ...
        reponse.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                valider.setEnabled(true); //Déblocaqe du bouton valider
        ...
        valider.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) { //Lorque l'utilisateur appuie sur le bouton valider
                vib.vibrate(10);
                Intent intent = new Intent(Enigme8Activity.this, CoordonneeActivity.class);
                Bundle bundle = new Bundle();
                bundle.putString("coordonnee11_txt", ev_reponse);
        ...
        indice1.setOnClickListener(new View.OnClickListener() {
                    /* Si l'utilisateur clique */
                    public void onClick(View v) { //Lorque l'utilisateur appuie sur le bouton indice
                        vib.vibrate(10);
                        NombreIndice = true;
                        SharedPreferences sharedPreferences = getPreferences(MODE_PRIVATE);
                        SharedPreferences.Editor editor = sharedPreferences.edit();

                        editor.putBoolean("8", NombreIndice);
                        editor.apply(); //Permet de sauvegarder dans les preferences l'utilisation d'un indice
                        trouve = true;
                        Intent intent = new Intent(Enigme8Activity.this, QuestionnaireActivity.class);
                        Bundle bundle = new Bundle();
                        bundle.putBoolean("indices8_txt", trouve);
                        intent.putExtras(bundle);
                        startActivity(intent);
