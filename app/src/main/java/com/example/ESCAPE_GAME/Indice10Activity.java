...
public class Indice10Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.question10_view);
        reponse = findViewById(R.id.reponse10_txt);
        valider = findViewById(R.id.indice10_btn);
        commentaire = findViewById(R.id.IndiceReponse10_view);
        indice = findViewById(R.id.image10View);
        ...
        retour.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                vib.vibrate(10);
                Intent intent = new Intent(Indice10Activity.this, Enigme10Activity.class);
