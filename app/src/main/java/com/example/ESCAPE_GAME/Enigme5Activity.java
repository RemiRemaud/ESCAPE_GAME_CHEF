...
public class Enigme5Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.enigme5_view); //Lien avec le layout
        reponse = findViewById(R.id.reponseEnigme5_txt); //Lien avec le layout
        nbindice = findViewById(R.id.nbindice5_view); //Lien avec le layout
        valider = findViewById(R.id.validerEnigme5_btn); //Lien avec le layout
        indice1 = findViewById(R.id.indice5_btn); //Lien avec le layout
        ...
        Boolean cc2 = sharedPreferences.getBoolean("5", false);//Recuperation des preferences
        ...
        valider.setOnClickListener(new View.OnClickListener() { //Lorque l'utilisateur appuie sur le bouton valider
            /* Si l'utilisateur clique */
            public void onClick(View v) {
                vib.vibrate(10);
                Intent intent = new Intent(Enigme5Activity.this, CoordonneeActivity.class);
                Bundle bundle = new Bundle();
                bundle.putString("coordonnee7_txt", ev_reponse);
        ...
        indice1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) { //Lorque l'utilisateur appuie sur le bouton indice
                        ...
                        editor.putBoolean("5", NombreIndice);
                        editor.apply(); //Permet de sauvegarder dans les preferences l'utilisation d'un indice
                        trouve = true;
                        Intent intent = new Intent(Enigme5Activity.this, QuestionnaireActivity.class);
                        Bundle bundle = new Bundle();
                        bundle.putBoolean("indices5_txt", trouve);
                        intent.putExtras(bundle);
                        startActivity(intent);
